 ...
 */
export function takeSurroundingDuplicates<T>(arr: T[], index: number, predicate: (val: T) => boolean);
 ...
 */
export function takeSurroundingDuplicates<T>(arr: T[], index: number, searchValue: T);
